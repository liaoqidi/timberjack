...
static JSON_INLINE int json_array_set(json_t *array, size_t index, json_t *value)
{
...
static JSON_INLINE int json_array_insert(json_t *array, size_t index, json_t *value)
{
